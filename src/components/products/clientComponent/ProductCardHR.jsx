    ...
    return (
        <div className='w-full rounded-2xl'>
            <div className='relative w-full h-full rounded-xl overflow-hidden'>
                ...
                <Image src={product.image} width={500} height={500} alt="Product Image" className='relative object-cover h-full w-full z-20 scale-130 -translate-y-2 translate-x-3.5 transition-transform duration-300'></Image>
