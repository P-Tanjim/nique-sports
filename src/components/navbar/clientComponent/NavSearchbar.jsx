    ...
    return (
        <>
            <button
                ...
                aria-label="Search"
                className={`relative backdrop-blur-sm lg:shadow h-11.5 w-11.5 md:h-10 md:w-10 items-center justify-center min-[1050px]:text-primary text-primary-light hover:text-primary rounded-full cursor-pointer transition-all duration-300 z-10 shadow-[inset_0_8px_8px_-8px_rgba(0,0,0,0.3),inset_0_-8px_8px_-8px_rgba(0,0,0,0.3)] ${isActive ? "scale-120" : ""}`}
            >
