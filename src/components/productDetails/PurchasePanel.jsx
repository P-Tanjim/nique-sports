      ...
      <div>
        ...
        <div className="mt-2 inline-flex h-11 items-center overflow-hidden rounded-xl border border-border bg-white">
          <button
            ...
            className="flex h-full w-11 items-center justify-center text-text-muted transition-colors enabled:hover:bg-surface disabled:cursor-not-allowed disabled:opacity-30"
          >
            <Minus size={14} />
          </button>
